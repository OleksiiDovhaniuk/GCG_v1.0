...
from ux.cell import AddCell, Cell, EmptyCell, IndexCell, TitleCell
from ux.flChsr import FlChsrIconLayout, FlChsrListLayout
from ux.layout import TTblRow
from design import Design
# from file_work import STORAGE_PATH


Builder.load_file('ui/dialog.kv')
...
class TruthTable(Dialog):
    ...
    def create_table(self, table):
        ...
        add_cell_column.bind(on_release=partial(
            self.add_column, add_cell_column))
